...
IPLEntry_CULL::IPLEntry_CULL(IPLFormat *pIPLFormat) :
	IPLEntry_Data(pIPLFormat, IPL_SECTION_CULL),
...
void			IPLEntry_CULL::unserialize(void)
{
...
void			IPLEntry_CULL::serialize(void)
{
