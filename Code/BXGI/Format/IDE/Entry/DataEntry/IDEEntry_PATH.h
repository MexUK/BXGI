...
public:
	...
	void								setIDEPathType(bxgi::EIDEPathType EIDEPathTypeValue) { m_uiIDEPathType = EIDEPathTypeValue; }
	bxgi::EIDEPathType					getIDEPathType(void) { return m_uiIDEPathType; }
...
private:
	...
	bxgi::EIDEPathType					m_uiIDEPathType;
};